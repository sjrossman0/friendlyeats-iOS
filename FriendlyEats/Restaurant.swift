...
extension Restaurant: DocumentSerializable {
  ...
  static let categories = [
    ...
    init?(dictionary: [String : Any]) {
        guard let name = dictionary["name"] as? String else {fatalError("name")}
        guard let category = dictionary["category"] as? String else {fatalError("category")}
        guard let city = dictionary["city"] as? String else {fatalError("city")}
        guard let price = dictionary["price"] as? Int else {fatalError("price")}
        guard let ratingCount = dictionary["numRatings"] as? Int else {fatalError("ratingCount")}
        guard let averageRating = dictionary["avgRating"] as? Float else {return nil}
